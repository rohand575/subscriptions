...
export function CurrencyPill({ currency }: { currency: Currency }) {
  return (
    <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-md border border-black/[0.08] bg-black/[0.03] px-1.5 text-xs font-semibold text-ink-600">
